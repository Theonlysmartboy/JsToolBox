...
Public Class UserPermissionRepository
    ...
    Private Const UserModelType As String = "App\Models\User"
    ...
    Public Function GetRolesForUser(userId As Long) As DataTable
        ...
        Dim parameters As New List(Of MySqlParameter) From {
            ...
            New MySqlParameter("@modelType", MySqlDbType.VarChar) With {
                .Value = UserModelType
            }
        }
    ...
    Public Function GetDirectPermissionIds(userId As Long) As HashSet(Of Long)
        Const sql As String = "SELECT permission_id " &
        ...
        Return ExecuteIdSet(sql, parameters.ToArray())
    End Function
    ...
    Private Function ExecuteDataTable(sql As String, Optional parameters As List(Of MySqlParameter) = Nothing) As DataTable
